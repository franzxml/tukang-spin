<div class="container">
    <div style="max-width: 600px; margin: 0 auto; background: var(--bg-secondary); padding: 30px; border-radius: 8px; border: 1px solid var(--border-color);">
        ...
        <form action="<?= BASEURL; ?>/artifacts/store" method="POST" autocomplete="off">
            ...
            <div style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 5px; color: var(--accent-color);">Bonus 2-Set</label>
                <input type="text" name="bonus_2pc" placeholder="Contoh: Energy Recharge +20%" required style="width: 100%; padding: 10px; background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); border-radius: 6px;">
            </div>

            <div style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 5px; color: var(--text-secondary);">Bonus 4-Set</label>
                <textarea name="bonus_4pc" rows="3" placeholder="Contoh: Meningkatkan DMG Elemental Burst sebesar 25%..." required style="width: 100%; padding: 10px; background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); border-radius: 6px; resize: vertical;"></textarea>
            </div>
