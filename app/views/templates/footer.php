 ...
 * Features a split layout with developer info on the left and a quote on the right.
 */
?>
    ...
    <div class="container footer-content">
        ...
        <div class="footer-left">
            ...
            <div class="footer-socials">
                ...
                <a href="https://github.com/franzxml" target="_blank" aria-label="GitHub">
                    <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div class="footer-right">
            <p class="footer-quote">"Every journey has its final day. Don't rush."</p>
        </div>
